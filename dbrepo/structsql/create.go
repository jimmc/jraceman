...
func CreateTable(db compat.DBorTx, tableName string, entity interface{}) error {
...
func CreateTableWithUpdater(db compat.DBorTx, tableName string, entity interface{}, updater ColumnInfosUpdater) error {
